...
//        
//        if(b[l][m+1]){
//            if(dist(b[l][m+1].x,b[l][m+1].y,this.x,this.y)==(2*r) && this.col.levels[0]===b[l][m+1].col.levels[0] && this.col.levels[1]===b[l][m+1].col.levels[1] && this.col.levels[2]===b[l][m+1].col.levels[2]){
//                        b[l][m+1].exist=0;
//                                b[l][m+1].spread(l,m+1);
//            }
//            
//        }
//        if(b[l][m-1]){
